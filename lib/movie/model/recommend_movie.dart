...
part 'recommend_movie.g.dart';


@JsonSerializable()
  class RecommendMovie extends Object {
  ...
  RecommendMovie(this.count,this.start,this.total,this.subjects,this.title,);

  factory RecommendMovie.fromJson(Map<String, dynamic> srcJson) => _$RecommendMovieFromJson(srcJson);

  Map<String, dynamic> toJson() => _$RecommendMovieToJson(this);
